...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Song.collection'
        db.add_column(u'rep_song', 'collection',
                      self.gf('django.db.models.fields.CharField')(max_length=75, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Song.collection'
        db.delete_column(u'rep_song', 'collection')
    ...
    models = {
        ...
        u'rep.song': {
            ...
            'collection': ('django.db.models.fields.CharField', [], {'max_length': '75', 'null': 'True'}),
